$(document).ready(function(){
    ...
    siguiente.click(function(){
        ...
        if (contador === 2) {
            parrafo1.remove();
            parrafo2.remove();
            parrafo1.textContent=pag5;
            parrafo2.textContent=pag6;
            paginaIzquierda.append(parrafo1);
            paginaDerecha.append(parrafo2);
        }
        if (contador === 3) {
            parrafo1.remove();
            parrafo2.remove();
            parrafo1.textContent=pag7;
            parrafo2.textContent=pag8;
            paginaIzquierda.append(parrafo1);
            paginaDerecha.append(parrafo2);
        }
        if (contador === 4) {
            parrafo1.remove();
            parrafo2.remove();
            parrafo1.textContent=pag9;
            parrafo2.textContent=pag10;
            paginaIzquierda.append(parrafo1);
            paginaDerecha.append(parrafo2);
        }
        if (contador === 5) {
            parrafo1.remove();
            parrafo2.remove();
            parrafo1.textContent=pag11;
            parrafo2.textContent=pag12;
            paginaIzquierda.append(parrafo1);
            paginaDerecha.append(parrafo2);
        }
